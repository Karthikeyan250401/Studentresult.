...
<title>LPU</title>
<body>
<img src="logoleft.png"  align="left"width="100" height="100">
<center><img src="logo.jpg" width="100" height="100">
<!--<img src="sjit.png" align="right"  width="100" height="100">-->
</center>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insert.jsp" method="post">
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Problem Solving and Programming.</label>
                                    <div class="col-md-6">
